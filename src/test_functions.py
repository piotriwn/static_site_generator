...
class Test_text_node_to_html_node(unittest.TestCase):
    ...
    def test_wrong_type(self):
        node = TextNode("This is a text node", "something wrong")
...
class Test_split_nodes_delimiter(unittest.TestCase):
    ...
    def test_empty_bold(self):
        node = TextNode("What is **** going on!?", TextType.TEXT)
        new_nodes = split_nodes_delimiter([node], "**", TextType.BOLD)
        self.assertListEqual(
            [
                TextNode("What is ", TextType.TEXT),
                TextNode(" going on!?", TextType.TEXT)
            ],
            new_nodes,
        )
...
class Test_extract_markdown_images(unittest.TestCase):
    ...
    def test_extract_markdown_images_tricky(self):
        alt = "image12!@#$%^&*-_=:.,/?/"
        link = "https://i.imgur.com/zjjc$?KZ=<>()*&^%$#!@.png"
        matches = extract_markdown_images(
            f"This is text with an ![{alt}]({link})"
        )
        self.assertListEqual(
            [(alt, link)], matches)
    ...
    def test_no_images_tricky(self):
        matches = extract_markdown_images(
            "This is text with an [image](https://i.imgur.com/zjjcJKZ.png)"
        )
        self.assertListEqual(
    ...
    def test_no_images_tricky2(self):
        matches = extract_markdown_images(
            "This is text with an ![image)](https://i.imgur.com/zjjcJKZ.png)"
        )
        self.assertListEqual(
...
class Test_extract_markdown_links(unittest.TestCase):
    ...
    def test_extract_markdown_links_tricky(self):
        alt = "image12!@#$%^&*-_=:.,/?/"
        link = "https://i.imgur.com/zjjc$?KZ=<>()*&^%$#!@.png"
        matches = extract_markdown_links(
            f"This is text with an [{alt}]({link})"
...
class Test_split_nodes_image(unittest.TestCase):
    ...
    def test_split_images2(self):
        node = TextNode(
            "![image](https://i.imgur.com/zjjcJKZ.png) and another ![second image](https://i.imgur.com/3elNhQu.png) something after!!",
            TextType.TEXT,
        )
        new_nodes = split_nodes_image([node])
        self.assertListEqual(
            [
                ...
                TextNode(" something after!!", TextType.TEXT),
...
class Test_split_nodes_link(unittest.TestCase):
    ...
    def test_split_links_nothing_after(self):
        node = TextNode(
